      ...
      <div className="flex items-start gap-3">
        <div
          className={cn(
            ...
            toast.variant === "success" ? "bg-emerald-50 text-emerald-700" : "bg-rose-50 text-rose-700"
          )}
        >
        ...
        <div className="min-w-0 flex-1">
          ...
          {toast.message ? <p className="mt-1 text-sm leading-6 text-muted-foreground">{toast.message}</p> : null}
        </div>
        <button
          type="button"
          onClick={onDismiss}
